                                ...
                                if contador_hoteis>max_hoteis:
                                    ...
                                    # Se não estourar a capacidade máxima
                                        ...
                                        if  data_horario_primeiro_hotel - data_horario_hotel>intervalo_pu_hotel:
                                            ...
                                            carros, df_servicos, data_horario_primeiro_hotel, bairro, 
                                            paxs_total_roteiro = abrir_novo_carro(carros, df_servicos, value, index, paxs_hotel)
...
if roteirizar and servico_roteiro=='OUT (BOA VIAGEM | PIEDADE)':
    ...
    df_roteiros_alternativos_bv = gerar_roteiros_alternativos(df_router_filtrado_bv_2)

    # Gerando roteiros alternativos Piedade

    df_roteiros_alternativos_pd = gerar_roteiros_alternativos(df_router_filtrado_pd_2)
...
if 'nome_html' in st.session_state and len(st.session_state.df_roteiros_alternativos)>0 and \
    st.session_state.servico_roteiro!='OUT (BOA VIAGEM | PIEDADE)':
